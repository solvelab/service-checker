...
from app.modules.openai.monitor import (
    OpenAIStatusMonitor,
    get_monitor,
)

FIXTURE = Path(__file__).parent / "fixtures" / "openai" / "summary.json"
_DEGRADED = "degraded_performance,partial_outage,major_outage"
_SLUG = "openai"
_MONITOR = OpenAIStatusMonitor
